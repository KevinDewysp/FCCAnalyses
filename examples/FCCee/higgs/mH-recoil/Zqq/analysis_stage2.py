'''
Second stage of the example Z(qq)H recoil mass analysis.
'''
...
class Analysis():
    ...
    def __init__(self, _):
        self.process_list = {
            ...
            'wzp6_ee_qqH_ecm240_out': {'output': 'MySample_wzp6_ee_qqH_ecm240'}
        }
        ...
        self.input_dir = '/eos/user/k/kdewyspe/4_Sept/FCCee/MidTerm/Zqq/stage1_10.0'

        # Optional: output directory, default is local dir
        self.output_dir = '/eos/user/k/kdewyspe/4_Sept/FCCee/MidTerm/Zqq/stage2'
    ...
    def analyzers(self, dframe):
        ...
        dframe2 = (
            ...
            .Filter('Z_hadronic_m.size() == 1')
            # Define Z candidate mass
            .Define('m_z', 'Z_hadronic_m[0]')
            # Define Z candidate recoil mass
            .Define('recoil_m', 'zed_hadronic_recoil_m[0]')
            ...
            # .Define('MyFilter', 'myFilter(Z_hadronic_m)')
        )
        return dframe2

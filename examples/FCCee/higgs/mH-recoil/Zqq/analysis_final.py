...
inputDir  = '/eos/user/k/kdewyspe/4_Sept/FCCee/MidTerm/Zqq/stage2'

#Input directory where the files produced at the pre-selection level are
outputDir  = '/eos/user/k/kdewyspe/4_Sept/FCCee/MidTerm/Test_mumu/final'
...
histoList = {
    "mz":{"name":"m_z","title":"m_{Z} [GeV]","bin":125,"xmin":0,"xmax":250},
